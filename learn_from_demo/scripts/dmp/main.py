...
if __name__ == '__main__':
    ...
    Set Parameters 
    '''
    with open('/home/syl/ROS_WorkSpaces/rosTuT_ws/src/moveit_skill/probot_demo/scripts/dmp_test/config_param1.yaml', 'r') as file:
    ...
    position_start_new = np.atleast_2d([1, 0.7, 0.2]).T  # here set the start position
    position_goal_new = np.atleast_2d([0.3, -0.7, 0.3]).T
